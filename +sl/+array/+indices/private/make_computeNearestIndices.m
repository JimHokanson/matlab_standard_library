function make_computeNearestIndices
...
params.src          = {};
params.target       = 'computeNearestIndices.cpp';
params.flags        = {};
...
params.objs         = { ...
    ...
    fullfile(this_dir,mexext,['computeNearestIndices.',objext])};
params.src          = {};
params.target       = 'mex_computeNearestIndices.cpp';
params.flags        = {};
[~,tmp] = fileparts(params.target);
output  = [tmp,'.',mexext];
