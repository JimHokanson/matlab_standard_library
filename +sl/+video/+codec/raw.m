...
% % %     end
    ...
    methods
        ...
        function output_data = decodeFrame(obj,input_data)
           ...
           output_data = zeros(obj.height,obj.width,3,'uint8');
           
           %This is poorly written in terms of efficiency ...
           for iDim = 1:3
              output_data(end:-1:1,:,4-iDim) = reshape(input_data(iDim:3:end),obj.width,obj.height)';
           end
