...
%
%
%   JAH NOTE: This code is a complete mess and I'd like to change the
%   output format but it seems to work so I'm leaving it alone for now.
...
try
    cache_size = [machdep.cache.size,' KB'];
catch
    %M1 Mac (or operating system, unclear)
    cache_size = [hw.l2cachesize,' KB'];
end
