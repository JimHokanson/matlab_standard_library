function findAndReplace(file, expression, replacement)
%
%
%   Improvements
%   ------------------------------
%   Build in examples of searching for the files first
%   Allow going from a search result to this file
%   Don't write if nothing changes
%
%
